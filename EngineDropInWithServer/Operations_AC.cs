    ...
    public class Operations {
        ...
        */
        ...
        public static FinalizedResponse Type_AC ( TokLinePlanB<PTok> orig_TL , TokLinePlanB<PTok>.CPosC CPos , NamedNode n ,  Responder RESP ) {
            ...
            Func<PTokE,bool> ON    = tokE => { var tok = CPos.on_tok ;            if ( tok == null ) return false ; return tok.E == tokE ; }; 
            ...
            if ( ON( PTokE.CS_name ) || AFTER ( PTokE.CS_name )) { 
                PTok targetTok = null ;
                if ( (CPos.on_tok != null) && (CPos.on_tok.E == PTokE.CS_name ) ) targetTok = CPos.on_tok; 
        ...
        */ 
        ...
        public static ShellCommon.AC_Resp AC ( ShellCommon.AC_Req shell_ac_request , Func<IEnumerable<PTokBase>,NamedNode> GetAst ) {
            ...
            */
            ...
            // with epsilon consuming productions ( ex: DeclStar ) all Leafs being TermNodes can not be relied on anymore 
            ...
            if      ( descrNode is MG.ACableMemb )     return MembAcc_AC( TokL , CPos , descrNode as MGRX.MemANodeRX , RESPONDER ).ac_response; // <- todo cast not typesafe 
