...
namespace TranslateAndEval {
    ...
    public class ScopingTests {
        ...
        public static string doing ( SObject obj ) {
            CH_Scope.Ref _ref;
        ...
        public static void Test3_preCH_delta () {
            ...
            Equivalent ( pdeltaSC.instantiate().close(),
        ...
        /*
             point of the deferred_adapter is that normal adapter_preCH ( CH ) can not be initialised like:
